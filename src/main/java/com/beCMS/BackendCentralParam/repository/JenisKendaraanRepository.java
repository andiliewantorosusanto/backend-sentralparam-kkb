...
import com.beCMS.BackendCentralParam.model.modelJenisKendaraan;
...
@DynamicUpdate
public interface JenisKendaraanRepository extends JpaRepository<modelJenisKendaraan, Integer> {
}